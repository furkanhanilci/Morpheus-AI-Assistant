...
class AgentExecutor:
    ...
    def execute(
        ...
        # PR-8: bridge — UI canlı plan view'ı için (opt-in, hata yutar)
        try:
        ...
        while True:
            ...
            for step in steps:
                if cancel_flag and cancel_flag.is_set():
                    ...
                    emit_plan_finished(False, "Task cancelled.")
                ...
                while attempt <= 3:
                    ...
                    try:
                        ...
                        if decision == ErrorDecision.RETRY:
                            ...
                            completed_steps.append(step)
                            emit_plan_step(step_num, tool, "skip",
                                           duration_s=_t.time() - _step_start,
                                           description=desc)
                            step_ok = True
                            break
            ...
            if success:
                ...
                emit_plan_finished(True, summary)
                return summary
